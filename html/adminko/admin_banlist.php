...
echo '
  <form action="index.php?sekcia=banlist&amp;x=1" method="post">
...
while ( $fetch = psw_mysql_fetch_array($query) ){
	...
	echo '
        <form action="index.php?sekcia=banlist&amp;x=2" method="post">
         <tr>
          <td align="center">
           ' .$fetch['ip']. '
          </td>
	...
	echo '
          ...
          <td align="center" colspan="3">
           <input type="hidden" value="' .$fetch['ban_id']. '" name="ban_id">
